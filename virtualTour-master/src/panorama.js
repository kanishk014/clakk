...
function initEventListener() {
  ...
  _("infoCloseButton").addEventListener(
    "click",
    function (event) {
  ...
  if (navGroup) {
    _("upNavButton").addEventListener(
      "mousedown",
      function (event) {
    ...
    _("downNavButton").addEventListener(
      "mousedown",
      function (event) {
        isUserInteracting = true;
        latFactor = -0.5;
    ...
    _("leftNavButton").addEventListener(
      "mousedown",
      function (event) {
        isUserInteracting = true;
        lonFactor = -0.5;
    ...
    _("rightNavButton").addEventListener(
      "mousedown",
      function (event) {
        isUserInteracting = true;
        lonFactor = 0.5;
    ...
    _("navigationButtonsContainer").addEventListener(
      "mouseup",
      onMouseUp,
      false
    );
...
function update() {
  ...
  if (!isPopupOpen) {
    ...
    console.log("Positions [100, 40, 60]" + vectorToString(camera.target));
    console.log("-----------------------------");
